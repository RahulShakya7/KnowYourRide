            ...
            if (!username || !password) {
                ...
                if (response.status === 200) {
                        ...
                        if (response.data.role === 'admin') {
                                goToPage("/admin"); // Redirect to the admin page if the role is 'admin'
                            } else {
                                goToPage("/home"); // Redirect to the home page for other roles
                        }
                    } else {
                        console.log("Else");
                ...
                <div className="w-full p-10 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
                    ...
                    <p className="mt-8 text-xs font-light text-center text-gray-700">
                        ...
                        Don't have an account?{" "}
                            <Link className="font-medium text-purple-600 hover:underline" to="/signup">Sign up</Link>
                    </p>
                </div>
            </div>
        </Helmet>
